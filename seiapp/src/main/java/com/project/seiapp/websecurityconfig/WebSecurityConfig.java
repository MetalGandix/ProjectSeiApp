...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				...
				.authorizeRequests().antMatchers("/authenticate","/edificioSingolo","/interventoA2","/edificioInAggregato","/interventoA1","/interventoA1/{interventoA1id}","/interventoA1/{interventoA1titolo}","/interventoA2/{interventoA2id}","/tipologiaStruttura", "/register","/strutturaVerticale", "/caratteristicheQualitative").permitAll().	
